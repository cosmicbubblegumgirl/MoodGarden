...
const SEEDS = {
  ...
  anxiety: {
    ...
    bpmHint: "50–70 BPM",
    steps: [
      "Choose very slow, repetitive ambient or nature-sounds music.",
      "Feel both feet flat on the floor. Name 5 things you can see.",
      "Breathe in for 4 counts, hold for 4, out for 6. Repeat twice.",
      "Write one small, safe thing you can do right now.",
      "Let the music carry you—you don't have to perform, just be."
    ]
  },
  burnout: {
    label: "Burnout",
    vibe: "gentle restoration",
    bpmHint: "55–75 BPM",
    steps: [
      "Choose soft, nurturing music—no lyrics, no urgency.",
      "Give yourself permission to do less than you think you should.",
      "Pick one tiny task that feels manageable. Just one.",
      "Rest fully between tasks—this is not laziness, it's recovery.",
      "End by writing one thing you are grateful your body did today."
    ]
  },
  creative_block: {
    label: "Creative Block",
    vibe: "flowing & curious",
    bpmHint: "80–100 BPM",
    steps: [
      "Choose music that surprises you—something new or genre-crossing.",
      "Spend 3 minutes doodling, writing nonsense, or humming randomly.",
      "Ask: 'What would I make if it didn't have to be good?'",
      "Make that thing. It doesn't need to be finished or shown to anyone.",
      "End by capturing one idea—a word, a sketch, a voice note."
    ]
  },
  restless_energy: {
    label: "Restless Energy",
    vibe: "channel the buzz",
    bpmHint: "95–130 BPM",
    steps: [
      "Match the music to your energy—fast, rhythmic, propulsive.",
      "Channel the energy into movement first: shake out, jump, pace.",
      "Pick the most stimulating task you've been putting off.",
      "Work in bursts—start the clock and go hard for 10 minutes.",
      "After each sprint, do 60 seconds of slow breathing to reset."
    ]
  }
};
